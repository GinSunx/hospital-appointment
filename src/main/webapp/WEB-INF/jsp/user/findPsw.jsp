				...
				<div class="row">
					<div class="col-sm-6 col-sm-offset-3 form-box">
						...
						<div class="form-bottom">
							<form role="form" action="findPsw" method="post" class="login-form" id="findPwdForm">
								<div class="form-group col-xs-12">
									<label class="sr-only" for="userIdent">userIdent</label>身份证号(*):<input
										type="text" name="userIdent"
										class="form-username form-control" id="userIdent" required
