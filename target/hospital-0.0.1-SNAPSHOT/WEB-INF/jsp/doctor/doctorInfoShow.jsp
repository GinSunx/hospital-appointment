			...
			<div class="col-md-12">
				<ul class="nav nav-tabs">
						...
						<li class=""><a href="#orderNotice" data-toggle="tab"
							aria-expanded="true">预约须知</a></li>
					<li class=""><a href="#about" data-toggle="tab"
						aria-expanded="true">医生简介</a></li>
				...
				<div class="col-md-12">
					...
					<div class="col-md-4">
						...
						<p class="text-left">
							<font color="#eb6864">医生科室：</font>${doctor.departName }
						</p>
						<p class="text-left">
				...
				<div id="myTabContent" class="tab-content">
						<div class="tab-pane fade active in text-left" id="home">
							...
							<form class="form-search form-horizontal" id="orderInfo"
								...
								<input type="hidden" id="hospitalName" name="hospName" value="${hos.hospName }"/>
								<input type="hidden" id="departName" name="departName" value="${doctor.departName }"/>
								<input type="hidden" id="doctorName" name="doctorName" value="${doctor.doctorName }"/>
								<input type="hidden" id="userIdent" name="userIdent" value="${userInfo.userIdent }"/>
