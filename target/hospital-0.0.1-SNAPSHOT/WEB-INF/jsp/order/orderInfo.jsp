		...
		<div id="page-inner">
				...
				<div class="panel-body">
					<div class="col-md-5">
						...
						<div class="col-md-9">
							...
							<p>医院名称：${orderRecords.hospName }</p>
							<p>科室名称：${orderRecords.departName }</p>
						</div>
					</div>
					<div class="col-md-7">
						<p>
							<font color="#eb6864">门诊类型：${orderRecords.departName }</font>
						</p>
						<p>
			...
			<div class="panel panel-primary text-left">
				...
				<div class="panel-body">
					<div class="col-md-12">
						<div class="col-md-2">
							<h3>${orderRecords.appointmentDate }</h3>
						</div>
					</div>
					<div class="col-md-12">
						<div class="col-md-10">
							<h3>就诊时间：${orderRecords.appointmentTime }</h3>
						</div>
					</div>
				</div>
			</div>
			<div class="panel panel-primary text-left">
				...
				<div class="panel-body">
					<div class="col-md-12">
						...
						<div class="col-md-5">
							<h3>&nbsp;身份证：${commonUser.userIdent }</h3>
						</div>
						<!-- <div class="col-md-2">
							<h3>&nbsp;1996-10-14</h3>
						</div> -->
						<div class="col-md-2">
							<h3>&nbsp;${commonUser.userTel }</h3>
						</div>
					</div>
					<div class="col-md-12">
						<div class="col-md-10">
