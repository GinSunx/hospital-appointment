				...
				<div class="col-sm-6 col-sm-offset-3 form-box">
					...
					<div class="form-bottom">
						<form role="form" action="sign" method="post" class="login-form">
							...
							<div class="form-group col-xs-12">
								<label class="sr-only" for="pwd1">password</label>密码(*):<input
									style="font-weight: bold" type="password" name="userPsw"
									class="form-password form-control" id="pwd1" required />
							</div>
							<div class="form-group col-xs-12">
								<label class="sr-only" for="pwd2">passwordCof</label>确认密码(*):<input
						...
						<span><a href="findPsw">找回密码</a></span>
						<span><a href="login" class="pull-right">用户登录</a></span>
					</div>
				</div>
			</div>
		</div>
