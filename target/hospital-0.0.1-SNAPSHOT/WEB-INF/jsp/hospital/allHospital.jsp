							...
							<div class="col-md-12">
								...
								<div class="col-md-2">
									<select style="margin-bottom: 6px;"
										class="col-md-2 form-control" id="hospLevel"
										name="hospLevel">
										<option value="默认" selected="selected">请选择医院等级</option>
										<c:forEach var="grade" items="${hospLevel }"
											varStatus="status">
											<c:choose>
												<c:when test="${commonCondition.hospLevel == grade }">
										...
										<c:forEach var="nature" items="${hospNature }"
											varStatus="status">
											<c:choose>
												<c:when test="${commonCondition.hospNature == nature }">
									...
									</select> <input class="col-md-3 form-control" id="hospName"
