	...
	<div id="page-wrapper" style="margin-top: 50px;">
		<div id="page-inner">
			...
			<div class="col-md-12">
				...
				<div class="col-md-12">
					<div class="col-md-3">
						<a href="<c:url value='/hosInfoShow/${hos.hospId}' />"><p class="text-left">${hos.hospName }
						</p></a>
					</div>
					<div class="col-md-3">
						<p class="text-right">
					...
					<div class="col-md-2">
						<p class="text-right">
							<font color="#eb6864">区域：</font>${hos.hospDistrict }
						</p>
					</div>
					<div class="col-md-2">
						<p class="text-right">
				...
				<div class="col-md-12">
					...
					<div class="col-md-4">
						<p class="text-left">
							<font color="#eb6864">医院名称：</font>${hos.hospName }
						</p>
						<p class="text-left">
							<font color="#eb6864">科室名称：</font>${depart.departName  }
						</p>
						<p class="text-left">
							<font color="#eb6864">医生数量：</font>${depart.doctorNum }
						</p>
						<p class="text-left">
							<font color="#eb6864">科室网址：<a href="${hos.hospUrl }"
				...
				<div id="myTabContent" class="tab-content">
					<div class="tab-pane fade active in text-left" id="home">
						<div class="col-md-12">
							<div class="col-md-12">
								<p class="text-left" style="float: left"><font color="#eb6864">请选择预约医生</font></p>
							<div class="search" style="float:left;margin-left:200px">
								<input type="text" placeholder="输入医生名字" style="height:35px;margin-right:5px;"> <a href="#" style="display:inline-block;margin-top:20px">点击查询</a>
							</div>
							</div>
